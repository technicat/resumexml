XML format and XSL converters to generate HTML, PDF, and RTF resumes (that last one was for recruiters, so they can remove your contact info and add buzzwords).
